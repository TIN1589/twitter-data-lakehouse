...
- `docs/PERFORMANCE_OPTIMIZATION.md` - Detailed guide
...
- `docs/DASHBOARD_SETUP.md` - Detailed guide with best practices
...
**New Guides:**
1. `/docs/PERFORMANCE_OPTIMIZATION.md` - Query tuning, benchmarks
2. `/docs/DASHBOARD_SETUP.md` - Dashboard creation, best practices
